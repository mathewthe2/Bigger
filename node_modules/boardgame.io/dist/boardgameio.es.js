    ...
    value: function render() {
      ...
      for (var i = 0; i < this.props.log.length; i++) {
        ...
        if (item.type == END_TURN) {
          ...
          currentTurn.push(React.createElement(
            'div',
  ...
  createClass(DebugMove, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.props.name,
        '(',
        React.createElement('span', { ref: function ref(r) {
            _this2.span = r;
          },
          className: 'arg-field',
  ...
  createClass(Debug, [{
    ...
    value: function render() {
      ...
      for (var name in this.props.moveAPI) {
        ...
        moves.push(React.createElement(
          KeyboardShortcut,
          { key: name, value: shortcut },
          React.createElement(DebugMove, { name: name, fn: fn })
        ));
      }
      ...
      return React.createElement(
        ...
        this.state.showLog || React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              KeyboardShortcut,
              { value: 'e' },
              React.createElement(DebugMove, { fn: this.props.endTurn, name: 'endTurn' })
            )
          ),
          React.createElement(
            'h3',
          ...
          React.createElement(
            'section',
            null,
            React.createElement(ReactJson, { src: this.props.gamestate.G,
              name: 'G',
          ...
          React.createElement(
            'section',
            null,
            React.createElement(ReactJson, { src: this.props.gamestate.ctx,
              name: 'ctx',
              enableClipboard: false,
              displayDataTypes: false })
          )
        ...
        this.state.showLog && React.createElement(
          'section',
          null,
          React.createElement(GameLog, { log: this.props.gamestate.log, initialState: this.props.gamestate._initial })
        )
      );
    }
  }]);
...
function Client(_ref) {
  ...
  return _temp = _class = function (_React$Component) {
    ...
    function WrappedBoard(props) {
      ...
      if (board) {
        _this._board = React.createElement(connect(function (state) {
          return state;
        }, ActionCreators)(board), { moves: moveAPI });
      }

      if (debug) {
        _this._debug = React.createElement(connect(function (state) {
...
var main = { Client: Client, Game: Game };
