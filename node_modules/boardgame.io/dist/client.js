(function (global, factory) {
	...
	(global.Client = factory(global.React));
...
var GameLog = function (_React$Component) {
  ...
  function GameLog() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = GameLog.__proto__ || Object.getPrototypeOf(GameLog)).call.apply(_ref, [this].concat(args))), _this), _this.onRewind = function (logIndex) {
      if (logIndex == null) {
        _this.context.store.dispatch(restore(_this._toRestore));
        return;
      }

      _this._toRestore = _this.context.store.getState();

      var initial = _this.props.initialState;
      _this.context.store.dispatch(restore(initial));
  ...
  createClass(GameLog, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < this.props.log.length; i++) {
        var item = this.props.log[i];
        if (item.type == END_TURN) {
          turnToLogIndex[turns.length] = i;
          turns.push(currentTurn);
          currentTurn = [];
        } else {
          var args = item.move.args || [];
          currentTurn.push(React__default.createElement(
            'div',
            { key: i, className: 'log-move' },
            item.move.type,
            '(',
            args.join(','),
            ')'
      ...
      var _loop = function _loop(_i) {
        var turn = turns[_i];
        log.push(React__default.createElement(
          'div',
          { key: _i,
            className: 'log-turn',
            onMouseOver: function onMouseOver() {
              return _this2.onRewind(turnToLogIndex[_i]);
            },
            onMouseOut: function onMouseOut() {
              return _this2.onRewind(null);
            } },
      ...
      for (var _i = 0; _i < turns.length; _i++) {
        _loop(_i);
      }
...
var DebugMove = function (_React$Component) {
  ...
  function DebugMove() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = DebugMove.__proto__ || Object.getPrototypeOf(DebugMove)).call.apply(_ref, [this].concat(args))), _this), _initialiseProps.call(_this), _temp), possibleConstructorReturn(_this, _ret);
  }

  createClass(DebugMove, [{
    key: 'getArg',
    value: function getArg(arg) {
      try {
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        this.props.name,
        '(',
        React__default.createElement('span', { ref: function ref(r) {
            _this2.span = r;
          },
          className: 'arg-field',
          onBlur: function onBlur() {
            return _this2.props.deactivate();
          },
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onClick = function () {
    _this7.props.activate();
  };

  this.onSubmit = function () {
    var argArray = [];
    var value = _this7.span.innerText;

    if (value && value.length) {
      var _args = value.split(",");
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = _args[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var arg = _step.value;

          argArray.push(_this7.getArg(arg));
        }
      } catch (err) {
    ...
    _this7.props.fn.apply(_this7, argArray);
    ...
    _this7.span.innerText = '';

    if (_this7.props.deactivate) {
      _this7.props.deactivate();
    }
  };
...
var KeyboardShortcut = function (_React$Component2) {
  inherits(KeyboardShortcut, _React$Component2);
  ...
  function KeyboardShortcut() {
    ...
    return _ret2 = (_temp2 = (_this3 = possibleConstructorReturn(this, (_ref2 = KeyboardShortcut.__proto__ || Object.getPrototypeOf(KeyboardShortcut)).call.apply(_ref2, [this].concat(args))), _this3), _this3.state = {
      active: false
    }, _this3.deactivate = function () {
      _this3.setState({ active: false });
    }, _this3.activate = function () {
  ...
  createClass(KeyboardShortcut, [{
    ...
    value: function render() {
      ...
      if (_typeof(this.props.children) === _typeof(this)) {
        child = React__default.cloneElement(this.props.children, {
...
var Debug = function (_React$Component3) {
  inherits(Debug, _React$Component3);

  function Debug(props) {
    classCallCheck(this, Debug);

    var _this5 = possibleConstructorReturn(this, (Debug.__proto__ || Object.getPrototypeOf(Debug)).call(this, props));
    ...
    _this5.saveState = function () {
      var json = JSON.stringify(_this5.props.gamestate);
      window.localStorage.setItem('gamestate', json);
    };

    _this5.restoreState = function () {
      var gamestateJSON = window.localStorage.getItem('gamestate');
      if (gamestateJSON !== null) {
        var gamestate = JSON.parse(gamestateJSON);
        _this5.context.store.dispatch(restore(gamestate));
      }
    };

    _this5.onClickMain = function () {
      _this5.setState({ showLog: false });
    };

    _this5.onClickLog = function () {
      _this5.setState({ showLog: true });
    };

    _this5.assignShortcuts();
    return _this5;
  }
  ...
  createClass(Debug, [{
    ...
    key: 'assignShortcuts',
    value: function assignShortcuts() {
      var taken = {
        'e': true,
        's': true,
        'r': true,
      ...
      for (var name in this.props.moveAPI) {
        var shortcut = name[0];
        if (t[shortcut]) {
      ...
      if (this.shortcuts == null) {
        ...
        var next = 97;
        var _shortcuts = {};
        for (var _name in this.props.moveAPI) {
    ...
    value: function render() {
      ...
      var moves = [];
      for (var name in this.props.moveAPI) {
        var fn = this.props.moveAPI[name];
        var shortcut = this.shortcuts[name];
        moves.push(React__default.createElement(
          KeyboardShortcut,
          { key: name, value: shortcut },
          React__default.createElement(DebugMove, { name: name, fn: fn })
        ));
      }

      var players = [];
      for (var i = 0; i < this.props.gamestate.ctx.numPlayers; i++) {
        var className = 'player active';
        if (i != this.props.gamestate.ctx.currentPlayer) {
          className = 'player';
        }
        players.push(React__default.createElement(
          'div',
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'div',
            { className: this.state.showLog ? 'item' : 'item active', onClick: this.onClickMain },
            'Main'
          ),
          React__default.createElement(
            'div',
            { className: this.state.showLog ? 'item active' : 'item', onClick: this.onClickLog },
            'Log'
          )
        ),
        this.state.showLog || React__default.createElement(
          'span',
          null,
          React__default.createElement(
            'section',
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              KeyboardShortcut,
              { value: 's', onPress: this.saveState },
              'save localStorage'
            ),
            React__default.createElement(
              KeyboardShortcut,
              { value: 'r', onPress: this.restoreState },
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              KeyboardShortcut,
              { value: 'e' },
              React__default.createElement(DebugMove, { fn: this.props.endTurn, name: 'endTurn' })
            )
          ),
          React__default.createElement(
            'h3',
          ...
          React__default.createElement(
            'section',
            null,
            React__default.createElement(ReactJson, { src: this.props.gamestate.G,
              name: 'G',
          ...
          React__default.createElement(
            'section',
            null,
            React__default.createElement(ReactJson, { src: this.props.gamestate.ctx,
              name: 'ctx',
              enableClipboard: false,
              displayDataTypes: false })
          )
        ...
        this.state.showLog && React__default.createElement(
          'section',
          null,
          React__default.createElement(GameLog, { log: this.props.gamestate.log, initialState: this.props.gamestate._initial })
        )
      );
    }
  }]);
...
var debug$10 = createCommonjsModule(function (module, exports) {
/**
 * This is the common logic for both the Node.js and web browser
 * implementations of `debug()`.
 *
...
exports = module.exports = debug$10;
exports.log = log;
exports.formatArgs = formatArgs;
exports.save = save;
exports.load = load;
...
var debug$9 = browser$7('engine.io-client:polling');
...
var debug$8 = browser$7('engine.io-client:polling-xhr');
...
var require$$1$3 = ( empty$3 && empty$2 ) || empty$3;
    ...
    (function (packet) {
      browser$5.encodePacket(packet, self.supportsBinary, function (data) {
        ...
        try {
          ...
          debug$12('websocket closed before onclose event');
        }
...
var Multiplayer = function () {
   ...
   */
  function Multiplayer(socketImpl, gameid, player) {
  ...
  createClass(Multiplayer, [{
    key: 'createStore',
    value: function createStore$$1(reducer) {
      var _this = this;

      var store = null;

      var whiteListedActions = new Set([MAKE_MOVE, END_TURN]);

      // Redux middleware to emit a message on a socket
      // whenever an action is dispatched.
      var SocketUpdate = function SocketUpdate(_ref) {
        ...
        return function (next) {
          return function (action) {
            ...
            if (whiteListedActions.has(action.type)) {
              _this.socket.emit('action', action, state._id, _this.gameid, _this.player);
            }
      ...
      case MAKE_MOVE:
        {
          ...
          return _extends$4({}, state, { G: G, _id: state._id + 1, log: log });
        }
      ...
      case END_TURN:
        {
          ...
          ctx = _extends$4({}, ctx, { currentPlayer: currentPlayer, turn: turn, winner: winner });

          // Update log.
          var _log = [].concat(toConsumableArray(state.log), [action]);

          return _extends$4({}, state, { G: _G, ctx: ctx, _id: state._id + 1, log: _log });
        }
...
function createDispatchers(moveNames, store) {
  ...
  try {
    ...
    for (var _iterator = moveNames[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      _loop();
    }
  } catch (err) {
    _didIteratorError = true;
...
function Client$1(_ref) {
  ...
  var GameReducer = createGameReducer({ game: game, numPlayers: numPlayers });
  ...
  return _temp = _class = function (_React$Component) {
    ...
    function WrappedBoard(props) {
      ...
      if (multiplayer) {
        _this.multiplayerClient = new Multiplayer(undefined, props.gameid, props.player);
        _this.store = _this.multiplayerClient.createStore(GameReducer);
      } else {
        _this.store = createStore(GameReducer);
      }

      var moveAPI = createDispatchers(game.moveNames, _this.store);

      if (board) {
        _this._board = React__default.createElement(connect(function (state) {
          return state;
        }, ActionCreators)(board), { moves: moveAPI });
      }

      if (debug) {
        _this._debug = React__default.createElement(connect(function (state) {
